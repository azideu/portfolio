  ...
  const educationTimeline = [
    {
      ...
      courses: [
        "Object-Oriented Programming (Java) (CSC186)",
        "Visual Programming (.NET 6 Visual Basic) (CSC301)",
        "Introduction to Computer Security (ITT320)",
        "Fundamental of Data Structure (CSC248)",
        "Introduction to Web & Mobile Application (CSC264)",
        "Information System Development (ISP250)",
        "Fundamentals of Operating Systems (CSC207)",
