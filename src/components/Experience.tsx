  ...
  const educationTimeline = [
    {
      ...
      period: "GRADUATED / ONGOING",
      description: "Rigorous foundational study covering systems design, procedural programming, structured query operations, and system automation workflows.",
      courses: [
        "Operating Systems Principles",
        "Database Design & Relational Modeling (ISP250)",
        "System Analysis & Design",
        "Object-Oriented Programming (Java) (CSC186/CSC264)",
        "Web Application Development",
      ],
      highlights: [
        "Group project designs implementing relational schema migrations.",
        "System simulation logic built using Java OOP patterns.",
      ],
